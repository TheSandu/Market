<?php
require 'config.php';
require 'proverca/pro_admin.php';
$find = R::find('users',
		...
		<div class="col-md-2" style=" padding:0;background-color:#222062; height:100%;color:#fff;">
			...
			<div class="list">
				...
				<ul>
					...
					<li class="list-menu" id="user_info">Info utilizatorir</li>
					<li class="list-menu" id="add_base" >Adauga in baza</li>
					<li class="list-menu"><buton type="submit" id="exit" style="background:none;border:none;" name="button"><i class="glyphicon glyphicon-log-out"></i> Exit</button></li>
				</ul>
			</div>
...
<div class="row" style="width:100%;">
		...
		<div class="col-md-4" style="display:none;font-size:1.2em;" id="page3">
			...
			<div class="col-md-9" id="page4" style="display:none;margin:10px;">
					...
					<div class="col-md-9" id="page5" style="display:none;margin:10px;">
									<div class="panel panel-default">
